  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(afAuth) {
        ...
        this.afAuth = afAuth;
        this.authSubscription = this.afAuth.authState.subscribe(function (authState) {
        ...
        value: function doLogout() {
          ...
          return new Promise(function (resolve, reject) {
            _this2.afAuth.auth.signOut().then(function () {
              _this2.authSubscription.unsubscribe();
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"]])], AuthService);
    /***/
  }
}]);
